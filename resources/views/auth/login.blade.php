...
@section('footer')
    ...
    <span class="float-end text-body-secondary text-nowrap">{{ __('Version') . ' ' . config('version.current') }}<x-buttons.icon-edit-modal :icon='"info-circle"' :color='"secondary"' :target='"#version-history-modal"' :tooltip='__("What has changed?")'></x-buttons.icon-edit-modal></span>
